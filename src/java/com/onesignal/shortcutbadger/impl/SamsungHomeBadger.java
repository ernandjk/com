...
public class SamsungHomeBadger implements Badger
{
    ...
    public void executeBadge(Context context, final ComponentName componentName, final int n) throws ShortcutBadgeException {
        final DefaultBadger defaultBadger = this.defaultBadger;
        ...
        try {
            ...
            if (query != null) {
                ...
                while (true) {
                    ...
                    context = (Context)query;
                    if (!className.equals((Object)((Cursor)query).getString(((Cursor)query).getColumnIndex("class")))) {
                        continue;
                    }
                    b = true;
                }
    ...
    public List<String> getSupportLaunchers() {
        return (List<String>)Arrays.asList((Object[])new String[] { "com.sec.android.app.launcher", "com.sec.android.app.twlauncher" });
    }
}
