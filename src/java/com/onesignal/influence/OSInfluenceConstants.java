...
public final class OSInfluenceConstants
{
    ...
    static {
        ...
        final String canonicalName = OSInAppMessageTracker.class.getCanonicalName();
        if (canonicalName == null) {
            throw new NullPointerException("null cannot be cast to non-null type kotlin.String");
        }
        IAM_TAG = canonicalName;
        final String canonicalName2 = OSNotificationTracker.class.getCanonicalName();
    ...
    public final String getIAM_TAG() {
        return OSInfluenceConstants.IAM_TAG;
    }
    
    public final String getNOTIFICATION_TAG() {
        return OSInfluenceConstants.NOTIFICATION_TAG;
    }
}
